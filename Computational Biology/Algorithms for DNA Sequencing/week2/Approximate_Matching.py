def naiveHamming(p, t, maxDistance):  # p: fragment, t: genome
...
#######################Approximate Match by BoyerMoore exact match####################################
...
# BoyerMoore-assisted approximate matching
# Implement the pigeonhole principle using BoyerMoore algorithm to find exact matches
def approximate_match(p, t, n):  # n is the max allowed edits
    ...
    for i in range(n+1):
        ...
        matches = boyer_moore(p[start:end], p_bm, t)  # check the occurrence indices of each fragment
