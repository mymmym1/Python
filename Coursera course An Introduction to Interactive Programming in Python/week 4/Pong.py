...
def new_game():
    ...
    spawn_ball(RIGHT) #firstly towards right
    score1 = 0
    score2 = 0
...
def draw(canvas):
    ...
    # draw scores
    canvas.draw_text(str(score1), [230,100], 30, "White")
    canvas.draw_text(str(score2), [350,100], 30, "White")
